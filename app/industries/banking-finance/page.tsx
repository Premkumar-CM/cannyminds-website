      ...
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex items-center justify-center gap-3 mb-6">
                <AccountBalance className="text-blue-700" sx={{ fontSize: 48 }} />
              </div>

              {/* CONTENT WRITER: Write H1 heading (6-10 words) */}
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                [Write Main Heading: Banking, Finance & Insurance IT Solutions]
              </h1>

              {/* CONTENT WRITER: Write sub-heading (20-35 words) - Must include: pain point + solution + benefit */}
              <p className="text-xl text-gray-600 mb-8">
                [Write sub-heading: ISO-compliant digital solutions for banking and financial institutions. Manage quality documents, automate production workflows, achieve compliance, and optimize workforce management.]
              </p>

              <div className="flex flex-wrap gap-4 justify-center">
                <Link href="/contact">
                  <button className="px-8 py-4 bg-blue-700 text-white font-semibold rounded-lg hover:bg-orange-700 transition-colors inline-flex items-center gap-2">
                    Request Demo
                    <ArrowForward fontSize="small" />
                  </button>
                </Link>
                <Link href="/#solutions">
                  <button className="px-8 py-4 bg-white text-gray-900 font-semibold rounded-lg border-2 border-gray-300 hover:border-blue-700 transition-colors">
                    View Solutions
                  </button>
                </Link>
              </div>
          ...
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-8 text-center">
                [Write H2: Digital Transformation for Banking, Finance & Insurance]
              </h2>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6 lg:px-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12 text-center">
              [Write H2: Key Challenges in Banking, Finance & Insurance]
            </h2>
              ...
              {challenges.map((challenge, index) => {
                ...
                return (
                  <div key={index} className="bg-white rounded-lg p-6 border border-gray-200">
                    <IconComponent className="text-blue-700 mb-4" sx={{ fontSize: 40 }} />
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6 lg:px-12">
            {/* CONTENT WRITER: Write H2 heading */}
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12 text-center">
              [Write H2: Our Solutions for Banking, Finance & Insurance]
            </h2>
              ...
              {solutions.map((solution, index) => {
                ...
                return (
                  <Link key={index} href={solution.link}>
                    <div className="bg-gray-50 rounded-lg p-8 border border-gray-200 hover:border-blue-700 transition-colors h-full">
                      <IconComponent className="text-blue-700 mb-4" sx={{ fontSize: 40 }} />
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6 lg:px-12">
            {/* CONTENT WRITER: Write H2 heading */}
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12 text-center">
              [Write H2: Why banking and financial institutions Choose CannyMinds]
            </h2>
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div key={index} className="bg-white rounded-lg p-6 text-center border border-gray-200">
                    <IconComponent className="text-blue-700 mx-auto mb-4" sx={{ fontSize: 48 }} />
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6 lg:px-12">
            {/* CONTENT WRITER: Write H2 heading */}
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12 text-center">
              [Write H2: How banking and financial institutions Use Our Solutions]
            </h2>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl mx-auto">
              {/* CONTENT WRITER: Write H2 heading */}
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-8 text-center">
                [Write H2: Why Financial Services Leaders Trust CannyMinds]
              </h2>
              ...
              <div className="bg-white rounded-lg p-8 border border-gray-200">
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="text-blue-700 mt-1 flex-shrink-0" />
                    <div>
        ...
        <section className="py-20 bg-blue-700 text-white">
          <div className="container mx-auto px-6 lg:px-12 text-center">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">
              [Write H2: Ready to Transform Your Financial Operations?]
            </h2>

            {/* CONTENT WRITER: Write sub-heading (20-30 words) - Create urgency, highlight free consultation */}
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              [Write sub-heading: Schedule a consultation with our financial services IT specialists to discuss your specific needs and see how we can help.]
            </p>

            <Link href="/contact">
              <button className="px-8 py-4 bg-white text-blue-700 font-semibold rounded-lg hover:bg-gray-100 transition-colors inline-flex items-center gap-2">
                Contact Us Today
                <ArrowForward fontSize="small" />
              </button>
            </Link>
